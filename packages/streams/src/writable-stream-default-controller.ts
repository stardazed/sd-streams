...
export function setUpWritableStreamDefaultControllerFromUnderlyingSink<InputType>(stream: ws.WritableStream<InputType>, underlyingSink: ws.WritableStreamSink<InputType>, highWaterMark: number, sizeAlgorithm: QueuingStrategySize<InputType>) {
