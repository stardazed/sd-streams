...
export function transformStreamError<InputType, OutputType>(stream: TransformStream<InputType, OutputType>, error: shared.ErrorResult) {
	rs.readableStreamDefaultControllerError(stream[readable_][rs.readableStreamController_] as rs.SDReadableStreamDefaultController<OutputType>, error);
	transformStreamErrorWritableAndUnblockWrite(stream, error);
}

export function transformStreamErrorWritableAndUnblockWrite<InputType, OutputType>(stream: TransformStream<InputType, OutputType>, error: shared.ErrorResult) {
...
export function transformStreamSetBackpressure<InputType, OutputType>(stream: TransformStream<InputType, OutputType>, backpressure: boolean) {
...
export function transformStreamDefaultControllerClearAlgorithms<InputType, OutputType>(controller: TransformStreamDefaultController<InputType, OutputType>) {
...
export function transformStreamDefaultControllerEnqueue<InputType, OutputType>(controller: TransformStreamDefaultController<InputType, OutputType>, chunk: OutputType) {
	...
	const readableController = stream[readable_][rs.readableStreamController_] as rs.SDReadableStreamDefaultController<OutputType>;
...
export function transformStreamDefaultControllerError<InputType, OutputType>(controller: TransformStreamDefaultController<InputType, OutputType>, error: shared.ErrorResult) {
...
export function transformStreamDefaultSinkAbortAlgorithm<InputType, OutputType>(stream: TransformStream<InputType, OutputType>, reason: shared.ErrorResult) {
	transformStreamError(stream, reason);
	return Promise.resolve(undefined);
}

export function transformStreamDefaultSinkCloseAlgorithm<InputType, OutputType>(stream: TransformStream<InputType, OutputType>) {
	...
	return flushPromise.then(
		_ => {
			...
			const readableController = readable[rs.readableStreamController_] as rs.SDReadableStreamDefaultController<OutputType>;
			if (rs.readableStreamDefaultControllerCanCloseOrEnqueue(readableController)) {
				rs.readableStreamDefaultControllerClose(readableController);
			}
		},
...
export function transformStreamDefaultSourcePullAlgorithm<InputType, OutputType>(stream: TransformStream<InputType, OutputType>) {
